...
export default function manifest() {
  const shortName = process.env.NEXT_PUBLIC_RESTAURANT_NAME?.trim() || "Thai Maki";
  return {
    id: "/",
    name: `${shortName} — order, book & owner tools`,
    short_name: shortName,
    description:
      "Order food, book a table, and manage your venue. Install for quick access and reliable alerts on your phone.",
    start_url: "/",
    scope: "/",
    display: "standalone",
